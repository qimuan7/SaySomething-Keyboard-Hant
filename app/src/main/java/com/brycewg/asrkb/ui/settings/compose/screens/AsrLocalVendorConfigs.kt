        ...
        AsrVendor.SenseVoice -> SenseVoiceConfig(
            ...
            onOpenGuide = {
                val intent = android.content.Intent(
                    context,
                    com.brycewg.asrkb.ui.MarkdownViewerActivity::class.java
                ).apply {
                    putExtra(com.brycewg.asrkb.ui.MarkdownViewerActivity.EXTRA_ASSET_PATH, "config_guide_offline/ConfigGuide_Offline.md")
                }
