...
Original Project Introduction (Simplified Chinese): [Open: Simplified Chinese](https://github.com/BryceWG/BiBi-Keyboard/blob/main/README.md)
...
- Recognizes Mandarin, Cantonese, regional languages, English, Japanese, and more.

- Fully offline voice recognition model, ranging from 100MB to 800MB, fast, accurate, stable, and privacy-protected.

### Input and Interface:

- AI editing panel; edit text with just voice commands.

- Customizable button layout.

- Material-3 and MIUIX interface styles.

- Multi-language display: Simplified Chinese, Traditional Chinese, English, Japanese.

- Minimalist initial setup.

### More Features: I only use it as a regular voice input method; some features await your discovery~
...
- Floating window permission (optional, for floating ball functionality)
...
- Has original application updates

- No Traditional Chinese input

- Includes online services and optional data collection

### [Branch 2 (Another branch of this repository)](https://github.com/qimuan7/SaySomething-Keyboard-Hant/tree/2)

- Compared to the original version, **has the same full functionality & content**
